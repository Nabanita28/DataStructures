...
public class CollectionCustomSorting {
    public static void main(String[] args) {
        ...
        System.out.println("Before dataStructuresPractice.sorting - " + orders);
        Collections.sort(orders);
        System.out.println("After natural dataStructuresPractice.sorting - " + orders);

        Collections.sort(orders, Collections.reverseOrder());
        System.out.println("Reverse dataStructuresPractice.sorting - " + orders);
    ...
    static class Orders implements Comparable<Orders> {
        ...
        //Sorting on orderId is natural dataStructuresPractice.sorting for Order.
        @Override
