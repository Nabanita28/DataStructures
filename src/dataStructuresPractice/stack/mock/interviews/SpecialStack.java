package dataStructuresPractice.stack.mock.interviews;
...
public class SpecialStack extends Stack {
    public static void main(String[] args) {
        ...
        System.out.println("Original dataStructuresPractice.stack : ");
        specialStack.stream().forEach(s-> System.out.print(s + " "));
        System.out.println();
        System.out.println("Min dataStructuresPractice.stack : ");
