...
public class MinValInBST {
    public static void main(String[] args) {
        ...
        System.out.println("Minimum val in a Binary dataStructuresPractice.tree - " + minValueInABinaryTree(root));
        System.out.println("Maximum val in a Binary dataStructuresPractice.tree - " + maxValueBinaryTree(root));
    }
